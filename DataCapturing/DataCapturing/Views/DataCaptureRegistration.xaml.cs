...
namespace DataCapturing.Views
{
    ...
    public partial class DataCaptureRegistration : ContentPage
    {
        public DataCaptureRegistration()
        {
            InitializeComponent();
        }
        ...
        async void AddDataCapturer()
        {
            ...
            else
            {
                ...
                var messageOptions = new MessageOptions
                {
                    Message = "Registred Admin Account Successfully",
                    Foreground = Color.White,
                    Font = Font.SystemFontOfSize(16),
                    Padding = new Thickness(20)
                };
